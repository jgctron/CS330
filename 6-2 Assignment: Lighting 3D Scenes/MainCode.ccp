...
int main(int argc, char* argv[])
{
	...
	g_ShaderManager->LoadShaders(
		"/Users/ssjtr/Downloads/CS330Content (1)/CS330Content/Utilities/shaders/vertexShader.glsl",
		"/Users/ssjtr/Downloads/CS330Content (1)/CS330Content/Utilities/shaders/fragmentShader.glsl");
	g_ShaderManager->use();
