...
int main(int argc, char* argv[])
{
    ...
    g_ShaderManager->LoadShaders(
        "/Users/ssjtr/Downloads/CS330Content (12)/CS330Content/Utilities/shaders/vertexShader.glsl",
        "/Users/ssjtr/Downloads/CS330Content (12)/CS330Content/Utilities/shaders/fragmentShader.glsl");
    g_ShaderManager->use();
...
void KeyCallback(GLFWwindow* window, int key, int scancode, int action, int mods)
{
    ...
    {
        std::cout << "Key pressed: " << key << std::endl; // Add this line
        if (g_SceneManager)
        {
            g_SceneManager->HandleInput(key, 0, 0);
        }
    }
}
