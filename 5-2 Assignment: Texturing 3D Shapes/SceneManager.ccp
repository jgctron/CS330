...
void SceneManager::LoadSceneTextures()
{
	...
	CreateGLTexture("C:/Users/ssjtr/Downloads/CS330Content (12)/CS330Content/Projects/5-2_Assignment/wood.png", "woodTexture");

	// Load the brick texture for the cone
	CreateGLTexture("C:/Users/ssjtr/Downloads/CS330Content (12)/CS330Content/Projects/5-2_Assignment/brick.png", "brickTexture");

	// Load the blue texture for the sphere
	CreateGLTexture("C:/Users/ssjtr/Downloads/CS330Content (12)/CS330Content/Projects/5-2_Assignment/blue.png", "blueTexture");

	// Load the yellow texture for the middle part
	CreateGLTexture("C:/Users/ssjtr/Downloads/CS330Content (12)/CS330Content/Projects/5-2_Assignment/yellow.png", "yellowTexture");

	// Load the red texture for the box
	CreateGLTexture("C:/Users/ssjtr/Downloads/CS330Content (12)/CS330Content/Projects/5-2_Assignment/red.png", "redTexture");
...
void SceneManager::RenderScene()
{
	...
	// Another Box - Apply yellow texture here
	...
	SetTransformations(scaleXYZ, XrotationDegrees, YrotationDegrees, ZrotationDegrees, positionXYZ);
	SetShaderTexture("yellowTexture");  // Apply yellow texture here
	m_basicMeshes->DrawBoxMesh();
	...
	SetTransformations(scaleXYZ, XrotationDegrees, YrotationDegrees, ZrotationDegrees, positionXYZ);
	SetShaderTexture("blueTexture");  // Apply blue texture for the sphere
	m_basicMeshes->DrawSphereMesh();

	// Cone with Brick Texture
